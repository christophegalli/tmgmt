...
class FormatManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, LanguageManager $language_manager, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/tmgmt_file/Format', $namespaces, 'Drupal\tmgmt_file\Annotation\FormatPlugin');
    $this->alterInfo($module_handler, 'tmgmt_file_format_plugin_info');
    $this->setCacheBackend($cache_backend, $language_manager, 'tmgmt_file_format_plugin');
  }
